def day_calculation(year_1, month_1, day_1, year_2, month_2, day_2):
	...
	elif  year_1 % 4 == 0 and day_1 > leap_year[month_1] or year_2 % 4 == 0 and day_2 > leap_year[month_2] or year_1 % 4 != 0 and day_1 > common_year[month_1] or year_2 % 4 != 0 and day_2 > common_year[month_2]:
		result = 'unfit'
